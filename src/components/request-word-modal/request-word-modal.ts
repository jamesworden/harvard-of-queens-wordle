class RequestWordModal {
	...
	private readonly responseText = document.getElementById('request-word-response-text');
	private readonly closeButton = document.getElementById('request-word-modal-close-button');
	...
	isFading() {
		return this.self.classList.contains('fade-in') || this.self.classList.contains('fade-out');
	}
